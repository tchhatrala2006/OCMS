...
<body>
    ...
    <div id="eventForm" class="form-box">
        ...
        <form action="{{url('/sportadd')}}" method="post">
            @csrf
                       <h3>{{__('welcome.heading37')}}</h3>
                         @if(session('sucess'))
         <h3 class="su">{{session('sucess')}}</h3>
    @else
      {{session('sucess')}}
    ...
    @endif
            ...
            <input type="text" placeholder="{{__('welcome.heading36')}}" name="en" class="{{$errors->first('en') ? 'ie':''}}">
            ...
            <select name="semname" id=""  class="{{$errors->first('semname') ? 'ie':''}}">
            ...
            <textarea placeholder="{{__('welcome.heading37')}}" name="tc"
             class="{{$errors->first('tc') ? 'ie':''}}"></textarea>

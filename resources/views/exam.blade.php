...
<body>
    ...
    <div id="eventForm" class="form-box">
        ...
        <form action="{{url('/exama')}}" method="post">
            @csrf
                       <h3>{{__('welcome.heading41')}}</h3>
                         @if(session('sucess'))
    ...
    @endif
            ...
            <input type="text" placeholder="{{__('welcome.heading40')}}" name="en" class="{{$errors->first('en') ? 'ie':''}}">
            ...
            <textarea placeholder="{{__('welcome.heading41')}}" name="tc"

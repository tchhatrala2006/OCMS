...
<body>
    ...
    <div id="eventForm" class="form-box">
      @foreach($data as $d)
        <form action="{{url('/uexam/'.$d->id)}}" method="post">
            @csrf
...
@endif
            ...
            <input type="text" placeholder="{{__('welcome.heading40')}}" name="en" value="{{$d->examname}}"
            ...
            <input type="text" placeholder="{{__('welcome.heading41')}}" name="tc" value="{{$d->complaintdetails}}"

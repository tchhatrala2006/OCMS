...
<body>
    ...
    <div id="eventForm" class="form-box">
      @foreach($data as $d)
        <form action="{{URL::to('/uacademic/'.$d->id)}}" method="post">
            @csrf
          ...
          @endif
            ...
            <input type="text" placeholder="{{__('welcome.heading39')}}" name="en" value="{{$d->academicname}}"
            ...
            <input type="text" placeholder="{{__('welcome.heading39')}}" name="tc" value="{{$d->complaintdetails}}"

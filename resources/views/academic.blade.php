...
<body>
    ...
    @endif
            ...
            <input type="text" placeholder="{{__('welcome.heading39')}}" name="en" class="{{$errors->first('en') ? 'ie':''}}">
            ...
            <textarea placeholder="{{__('welcome.heading39')}}" name="tc"
